...
def _parse_kc_date(value):
    ...
    Returns None when the field is missing or unparseable — certificates
    in particular often lack cdat/mdat in the dump format, and emitting
    Unix epoch zero for those pollutes the timeline."""
    if not value:
        return None
    try:
